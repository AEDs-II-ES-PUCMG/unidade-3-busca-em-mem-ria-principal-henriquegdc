    ...
    */
    ...
    private static Lista<Pedido> gerarPedidos(int quantidade) {
        ...
        for (int i = 0; i < quantidade; i++) {
			...
			idCliente = sorteio.nextInt(quantosClientes) + 10_001;
    ...
    public static void pedidosDoCliente() {
		int documento = lerOpcao("Digite o documento do cliente:", Integer.class);
		try {
			Cliente cliente = clientesPorId.pesquisar(documento);
			Lista<Pedido> pedidos = pedidosPorCliente.pesquisar(cliente);
			System.out.println("Cliente: " + cliente);
			System.out.println("Histórico de Pedidos:");
			System.out.println(pedidos);

		} catch (NoSuchElementException e) {
			System.out.println("Cliente não encontrado ou sem histórico de pedidos.");
		}
    }
